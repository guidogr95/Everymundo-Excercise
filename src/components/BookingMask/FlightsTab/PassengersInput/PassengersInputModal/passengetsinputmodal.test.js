...
describe('<PassengersInputModal/>', () => {
  ...
  test('renders controls', () => {  
    for (const passenger of Object.values(flightInitialState.passengers)) {
      expect(component.getByText(passenger.plural)).toBeInTheDocument()
    }
  })
