...
export const flightReducer = (state = initialState, action) => {
  console.log(state.passengers.adults.value + 1, state.passengers.adults.min)
  switch(action.type){
    ...
    case '@passengers/update-adults--subtract':
      return {
          ...
          adults: {
            ...state.passengers.adults,
            value: state.passengers.adults.value + 1 > (state.passengers.adults.min || 0) ? returnMinusOne(state.passengers.adults.value) : 0
          }
        }
      }
      ...
      case '@passengers/update-children--subtract':
        return {
            ...
            children: {
              ...state.passengers.children,
              value: state.passengers.children.value + 1 > (state.passengers.children.min || 0) ? returnMinusOne(state.passengers.children.value) : 0
            }
          }
        }
      ...
      case '@passengers/update-infants--subtract':
        return {
            ...
            infants: {
              ...state.passengers.infants,
              value: state.passengers.infants.value + 1 > (state.passengers.infants.min || 0) ? returnMinusOne(state.passengers.infants.value) : 0
            }
          }
        }
    default: 
