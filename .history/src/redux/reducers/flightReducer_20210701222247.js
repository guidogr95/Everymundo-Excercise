...
export const flightReducer = (state = initialState, action) => {
  console.log(state.passengers.adults.value, state.passengers.adults.min)
  switch(action.type){
    ...
    case '@passengers/update-adults--subtract':
      return {
          ...
          adults: {
            ...state.passengers.adults,
            value: state.passengers.adults.value > state.passengers.adults.min ? returnMinusOne(state.passengers.adults.value) : 0
          }
        }
      }
