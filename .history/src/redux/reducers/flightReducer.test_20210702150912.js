...
describe('flightReducer', () => {
  ...
  test('returns new state with updated number of specific passenger type', () => {
    const passengerType = 'adults'
    const initialNumber = flightInitialState.passengers[passengerType].value
    const newState = flightReducer(flightInitialState, passUpdateAdd(passengerType))
