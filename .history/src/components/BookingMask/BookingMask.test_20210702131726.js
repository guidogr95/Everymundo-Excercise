...
describe('<BookingMask/>', () => {
  ...
  test('renders content', () => {
    ...
    expect(component.container.querySelector('ul.bookingmask__nav')).toBeInDocument()
    expect(component.container.querySelector('div.bookingmask__tabs-wrapper')).toBeInDocument()
    expect(component.container.querySelector('div.bookingmask__tab')).toBeInDocument()
    expect(component.container.querySelector('section.bookingmask')).toBeInDocument()
  })
